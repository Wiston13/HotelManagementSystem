...
BEGIN TRY
    ...
    */
    ...
    ( 8,1,DATEADD(MINUTE,770,CAST(DATEADD(DAY,-4,@Today) AS datetime2(0))),'E20260807002',18,'Room',N'202',N'將房間 202 供應狀態更新為保留。'),
    ...
    (11,2,DATEADD(MINUTE,830,CAST(DATEADD(DAY,-3,@Today) AS datetime2(0))),'E20260807004',18,'Room',N'201',N'將房間 201 供應狀態更新為保留。'),
    (12,5,DATEADD(MINUTE,850,CAST(DATEADD(DAY,-3,@Today) AS datetime2(0))),'E20260807016',20,'Room',N'201',N'將房間 201 標記為待清潔。'),
    ...
    (29,5,DATEADD(MINUTE,810,CAST(DATEADD(DAY,-8,@Today) AS datetime2(0))),'E20260807016',20,'Room',N'301',N'將房間 301 標記為已清潔。'),
    ...
    (32,6,DATEADD(MINUTE,830,CAST(DATEADD(DAY,-5,@Today) AS datetime2(0))),'E20260807019',20,'Room',N'301',N'將房間 301 標記為已清潔。'),
    ...
    (37,1,DATEADD(MINUTE,800,CAST(DATEADD(DAY,-18,@Today) AS datetime2(0))),'E20260807006',20,'Room',N'201',N'將房間 201 標記為已清潔。'),
    ...
    (44,1,DATEADD(MINUTE,720,CAST(DATEADD(DAY,-58,@Today) AS datetime2(0))),'E20260807001', 9,'Room',N'200',N'新增房間【200】(房型: 經典單人房, 樓層: 2, 初始狀態: 開放販售)'),
